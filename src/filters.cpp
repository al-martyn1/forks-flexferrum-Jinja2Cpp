...
std::unordered_map<std::string, ExpressionFilter::FilterFactoryFn> s_filters = {
    ...
    { "left", FilterFactory<filters::StringConverter>::MakeCreator(filters::StringConverter::LeftMode) },
    { "right", FilterFactory<filters::StringConverter>::MakeCreator(filters::StringConverter::RightMode) },
